...
function Composition({ ...props }) {
    ...
    return (
        <>
            ...
            <directionalLight ref={keyLight} castShadow intensity={0.5}>
            ...
            <group ref={group} position={[0, -height / 2.65, 0]} {...props}>
                ...
                <Mac onClick={toggleMac} ref={mbp16} texture={currentTexture} scale={width / 80} position={[0, 2, 0]} rotation={[0.1, 0.1, 0]} />
            </group>
        </>
    )
}
